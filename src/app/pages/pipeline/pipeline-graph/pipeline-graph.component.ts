...
export class PipelineGraphComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.hasSourceNodeSub = this.pipelineService.hasSourceNodeChanged.subscribe((hasSourceNode: boolean) => {
            this.hasSourceNode = hasSourceNode;
        });
        this.hasDestinationNodeSub = this.pipelineService.hasDestinationNodeChanged.subscribe((hasDestinationNode: boolean) => {

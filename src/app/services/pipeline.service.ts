...
export class PipelineService {
    ...
    addSourceDataset(dataset: Dataset, alreadyHasSource: boolean, isDestination: boolean) {
        ...
        if (alreadyHasSource) {
            ...
            if (isDestination) {
                this.addNode(new Node(-2, dataset.name, NodeType.DESTINATION_LOCAL), this.nodes.length);

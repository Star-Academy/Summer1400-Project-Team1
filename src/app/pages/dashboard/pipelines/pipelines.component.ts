...
import { PipelineRow } from 'src/app/modals/pipeline';
...
export class PipelinesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.pipelineRowsSub = this.pipelineService.pipelineRowsChanged.subscribe((pipelineRows: PipelineRow[]) => {
